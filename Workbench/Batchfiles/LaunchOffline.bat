...
echo start %clientEXE% %clientLaunchParams% "-mod=%modList%" "-mission=%mission%" "%playerName%" -profiles=Profiles -dologs -nopause -adminlog -freezecheck "-scriptDebug=true"
start %clientEXE% %clientLaunchParams% "-mod=%modList%" "-mission=%mission%" "%playerName%" -profiles=Profiles -dologs -nopause -adminlog -freezecheck "-scriptDebug=true"
